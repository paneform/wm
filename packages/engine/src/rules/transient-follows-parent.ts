...
import { findMembership, isIgnoredSurface, windowClass } from "./rule.ts";
...
function findParent(
  world: World,
  transient: import("../schema.ts").WindowObservation,
): string | null {
...
function includesLeaf(node: import("../world.ts").BspNode, id: string): boolean {
