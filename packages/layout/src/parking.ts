...
import type { Clock, PlatformAdapter } from "./platform.js";
import type {
  DisplayId,
  DisplayObservation,
  Frame,
...
import type { ParkingCorner, ParkingFact, ParkingVisibility } from "./world.js";
import {
  PARKING_ACCEPTANCE_PT,
  PARKING_TYPICAL_VISIBILITY,
  RESTORE_MATCH_THRESHOLD,
} from "./constants.js";
import { fingerprint } from "./learn.js";
