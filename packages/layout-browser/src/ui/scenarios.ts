...
export const SCENARIOS: readonly Scenario[] = [
  ...
  },
  {
    ...
    ops: [
      { kind: "addWindow", ref: "churn", title: "Churn victim", width: 700, height: 450 },
      {
        kind: "updateWorkArea",
        display: "secondary",
        workArea: { x: -1920, y: 38, width: 1200, height: 1042 },
      },
  ...
  },
  {
    ...
    ops: [
      ...
      {
        kind: "command",
        command: { type: "moveWindow", windowId: "@w:fast", point: { x: 300, y: 300 } },
      },
      {
        kind: "command",
        command: { type: "moveWindow", windowId: "@w:slow", point: { x: 400, y: 400 } },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    ops: [
      {
        kind: "command",
        command: { type: "moveWindowToWorkspace", windowId: "@w:sim-1", workspace: "2" },
      },
