...
public enum ErrorCode: String, Codable, CaseIterable, Sendable { case invalidMessage = "invalid_message", invalidParams = "invalid_params", methodNotFound = "method_not_found", notReady = "not_ready", permissionDenied = "permission_denied", inventoryFailed = "inventory_failed", subscriptionNotFound = "subscription_not_found", replayUnavailable = "replay_unavailable", windowNotFound = "window_not_found", windowNotControllable = "window_not_controllable", invalidFrame = "invalid_frame", geometryRejected = "geometry_rejected", geometryVerificationFailed = "geometry_verification_failed", inventoryStale = "inventory_stale", internalError = "internal_error" }
...
public struct Subscribe: Codable, Equatable, Sendable { public var requestId: String; public var subscriptionId: String; public var topics: [EventTopic]; public var projection: Projection; public var afterSequence: UInt64?; public init(requestId: String, subscriptionId: String, topics: [EventTopic], projection: Projection = .delta, afterSequence: UInt64? = nil) { self.requestId = requestId; self.subscriptionId = subscriptionId; self.topics = topics; self.projection = projection; self.afterSequence = afterSequence } }
...
public enum ClientMessage: Codable, Equatable, Sendable {
    ...
    enum Keys: String, CodingKey, CaseIterable {
        case type, method, params, topics, projection
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "subscribe": try rejectUnknownKeys(decoder, allowed: ["type", "request_id", "subscription_id", "topics", "projection", "after_sequence"]); self = .subscribe(.init(requestId: try c.decode(String.self, forKey: .requestId), subscriptionId: try c.decode(String.self, forKey: .subscriptionId), topics: try c.decode([EventTopic].self, forKey: .topics), projection: try c.decodeIfPresent(Projection.self, forKey: .projection) ?? .delta, afterSequence: try c.decodeIfPresent(UInt64.self, forKey: .afterSequence)))
