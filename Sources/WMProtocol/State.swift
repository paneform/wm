...
public enum Method: String, Codable, CaseIterable, Sendable { case stateGet = "state.get", stateObserved = "state.observed", healthGet = "health.get", displayList = "display.list", windowList = "window.list", windowManage = "window.manage", windowUnmanage = "window.unmanage", windowFocus = "window.focus", windowMove = "window.move", windowFrameGet = "window.frame.get", windowFrameSet = "window.frame.set", debugAXFrameGet = "debug.ax.frame.get", debugAXFrameSet = "debug.ax.frame.set", debugAXFocus = "debug.ax.focus", debugEngineGet = "debug.engine.get", debugEngineSet = "debug.engine.set", workspaceList = "workspace.list", workspaceFocus = "workspace.focus", workspaceMoveWindow = "workspace.move_window", workspaceMoveWindowBulk = "workspace.move_window_bulk", workspaceMoveDisplay = "workspace.move_display", workspaceSetMode = "workspace.set_mode", layoutPolicySet = "layout_policy.set", geometryPolicySet = "geometry_policy.set", observeWindow = "observe.window", observeWorkspace = "observe.workspace", diagnosticsInventory = "diagnostics.inventory", inventoryRefresh = "inventory.refresh", configurationValidate = "configuration.validate", configurationReload = "configuration.reload", daemonPing = "daemon.ping", daemonPause = "daemon.pause", daemonResume = "daemon.resume", daemonShutdown = "daemon.shutdown", transactionGet = "transaction.get", commandBatch = "command.batch" }
public enum EventTopic: String, Codable, CaseIterable, Sendable { case windowInventory = "window.inventory", windowClosed = "window.closed", displayInventory = "display.inventory", healthChanged = "health.changed", configurationChanged = "configuration.changed", inventoryRefreshed = "inventory.refreshed", daemonReady = "daemon.ready", daemonPaused = "daemon.paused", daemonResumed = "daemon.resumed", sessionResynchronized = "session.resynchronized", stateSnapshot = "state.snapshot", workspaceChanged = "workspace.changed", workspaceFocused = "workspace.focused", workspaceCreated = "workspace.created", workspaceDeleted = "workspace.deleted", workspaceDisplayChanged = "workspace.display_changed", workspaceModeChanged = "workspace.mode_changed" }
