...
public enum Method: String, Codable, CaseIterable, Sendable { case stateGet = "state.get", stateObserved = "state.observed", healthGet = "health.get", displayList = "display.list", windowList = "window.list", windowFrameGet = "window.frame.get", windowFrameSet = "window.frame.set", workspaceList = "workspace.list", workspaceFocus = "workspace.focus", workspaceMoveWindow = "workspace.move_window", workspaceMoveDisplay = "workspace.move_display", workspaceSetMode = "workspace.set_mode", observeWindow = "observe.window", diagnosticsInventory = "diagnostics.inventory", inventoryRefresh = "inventory.refresh", daemonPing = "daemon.ping" }
public enum EventTopic: String, Codable, CaseIterable, Sendable { case windowInventory = "window.inventory", displayInventory = "display.inventory", healthChanged = "health.changed", inventoryRefreshed = "inventory.refreshed", daemonReady = "daemon.ready", workspaceChanged = "workspace.changed", workspaceFocused = "workspace.focused", workspaceCreated = "workspace.created", workspaceDeleted = "workspace.deleted", workspaceDisplayChanged = "workspace.display_changed", workspaceModeChanged = "workspace.mode_changed" }
